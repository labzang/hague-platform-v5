...
from labzang.apps.data.kaggle.santander.domain.entities import Passenger, SeoulCrime
from labzang.apps.data.kaggle.santander.domain.value_objects import (
    Age,
    Embarked,
    Fare,
    Pclass,
