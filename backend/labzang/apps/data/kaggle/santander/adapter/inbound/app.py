...
try:
    from labzang.apps.data.kaggle.santander.application.config import TitanicServiceConfig
...
from labzang.apps.data.kaggle.santander.adapter.inbound.api.v1 import (  # noqa: E402
    titanic_router,
    seoul_crime_router,
    wordcloud_router,
