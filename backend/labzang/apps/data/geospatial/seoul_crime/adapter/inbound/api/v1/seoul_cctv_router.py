...
from labzang.apps.data.geospatial.seoul_crime.application.services.cctv_matrix_service import (
    CctvMatrixService,
)
...
async def upload_cctv_csv(
    ...
    """버셀·프론트 등에서 CSV를내면 processed 경로에 저장하고 `create_matrix`를 실행한다."""
