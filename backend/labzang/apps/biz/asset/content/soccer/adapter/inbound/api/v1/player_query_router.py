...
from labzang.apps.biz.asset.content.soccer.application.use_cases.player_query_impl import PlayerQueryImpl
from labzang.apps.biz.asset.content.soccer.application.ports.input.player_query import PlayerQuery
from labzang.apps.biz.asset.content.soccer.adapter.outbound.impl.player_reader_impl import PlayerReaderImpl
from labzang.apps.biz.asset.content.soccer.adapter.inbound.schemas.player_response import PlayerResponse
router = APIRouter()
