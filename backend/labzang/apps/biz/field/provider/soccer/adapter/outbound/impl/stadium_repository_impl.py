...
from labzang.apps.biz.asset.content.soccer.application.ports.output.stadium_repository import (
    StadiumRepository,
)
from labzang.apps.biz.asset.content.soccer.domain.entities.stadium import Stadium
