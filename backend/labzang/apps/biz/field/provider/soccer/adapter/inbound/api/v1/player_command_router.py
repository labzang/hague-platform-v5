...
from labzang.apps.biz.asset.content.soccer.application.ports.input.player_command import PlayerCommand
from labzang.apps.biz.asset.content.soccer.application.use_cases.player_command_impl import PlayerCommandImpl
from labzang.apps.biz.asset.content.soccer.adapter.outbound.impl.player_repository_impl import PlayerRepositoryImpl

router = APIRouter()
logger = logging.getLogger(__name__)


def get_player_command() -> PlayerCommand:  # pyright: ignore[reportUndefinedVariable]
