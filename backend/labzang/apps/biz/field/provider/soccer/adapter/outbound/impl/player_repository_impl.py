...
from labzang.apps.biz.asset.content.soccer.application.ports.output.player_repository import (
    PlayerRepository,
)
from labzang.apps.biz.asset.content.soccer.domain.entities.player import Player
