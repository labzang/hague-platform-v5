...
from labzang.apps.biz.asset.content.soccer.application.dtos.team_dto import TeamDTO
from labzang.apps.biz.asset.content.soccer.adapter.outbound.orm.team_orm import TeamORM
from labzang.apps.biz.asset.content.soccer.application.ports.output.team_reader import TeamReader
