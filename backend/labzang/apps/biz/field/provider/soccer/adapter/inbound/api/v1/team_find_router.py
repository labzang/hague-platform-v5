...
from labzang.apps.biz.asset.content.soccer.adapter.inbound.schemas.team_response import TeamResponse
from labzang.apps.biz.asset.content.soccer.adapter.outbound.impl.team_reader_impl import (
    TeamReaderImpl,
)
from labzang.apps.biz.asset.content.soccer.application.ports.input.team_query import TeamQuery
from labzang.apps.biz.asset.content.soccer.application.use_cases.team_query_impl import TeamQueryImpl
