...
try:
    ...
    class _ITitanicDataPortStub(ABC):
        @abstractmethod
    ...
    class _IPreprocessorPortStub(ABC):
        @abstractmethod
        def preprocess(self, train_df: Any, test_df: Any) -> Any: ...

    class _IModelRunnerPortStub(ABC):
        @abstractmethod
    ...
    ITitanicDataPort = _ITitanicDataPortStub  # type: ignore[misc, assignment]
    IPreprocessorPort = _IPreprocessorPortStub  # type: ignore[misc, assignment]
    IModelRunnerPort = _IModelRunnerPortStub  # type: ignore[misc, assignment]
