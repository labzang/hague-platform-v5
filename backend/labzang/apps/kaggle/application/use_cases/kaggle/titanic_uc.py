...
from labzang.apps.ml.application.dtos.titanic_dto import PreprocessResult
...
# 평가 유스케이스는 별도 모듈 — 기존 `from ...titanic_uc import EvaluateTitanicUC` 경로 유지
from labzang.apps.ml.application.use_cases.kaggle.evaluate_titanic_uc import (  # noqa: E402
    EvaluateTitanicUC,
)
