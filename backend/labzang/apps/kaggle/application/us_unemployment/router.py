...
from labzang.apps.kaggle.application.us_unemployment.service import (
    USUnemploymentService,
)
from labzang.shared import create_response, create_error_response
from labzang.apps.kaggle.application.common.font_utils import (
    test_korean_font,
...
async def get_unemployment_stats():
    ...
    try:
        ...
        if stats is None:
            raise HTTPException(
                status_code=404, detail="실업률 데이터를 찾을 수 없습니다"
            )
