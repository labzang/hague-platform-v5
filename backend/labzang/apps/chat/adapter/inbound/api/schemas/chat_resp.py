...
class DocumentResp(BaseModel):
    ...
    score: Optional[float] = Field(default=None, description="유사도 점수")
...
class SearchResp(BaseModel):
    ...
    documents: List[DocumentResp] = Field(..., description="검색된 문서 목록")
...
class RAGResp(BaseModel):
    ...
    sources: Optional[List[DocumentResp]] = Field(None, description="참조된 문서 목록")
    retrieved_documents: Optional[List[DocumentResp]] = Field(
    ...
    def set_retrieved_fields(self) -> "RAGResp":
