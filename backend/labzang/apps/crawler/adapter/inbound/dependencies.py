...
from labzang.apps.crawler.application.use_cases import BugsmusicUC
from labzang.apps.crawler.adapter.outbound.client.bugsmusic_crawler import BugsmusicCrawler
