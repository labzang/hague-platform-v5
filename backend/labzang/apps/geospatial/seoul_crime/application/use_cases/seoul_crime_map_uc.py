...
class SeoulCrimeMapUseCase:
    """업로드된 processed 데이터를 기준으로 서울 범죄 지도를 생성한다."""
    ...
    def execute(self, *, force_geocode: bool = False) -> SeoulCrimeMapResult:
        self._load_inputs()
        self.update_cctv().update_pop().update_crime(force_geocode=force_geocode).update_police()
        ...
        return SeoulCrimeMapResult(
            ...
            saved_files={
                ...
                "police_norm": str((self.processed_dir / "police_norm_in_seoul.csv").resolve()),
            },
            summary={
