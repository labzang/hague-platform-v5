"""
벅스 차트 크롤링 아웃바운드 어댑터 (BugsCrawlerPort 구현).
...
from labzang.apps.ext.bridge.crawler.music.app.ports.output.bugs_crawler_port import (
    BugsCrawlerPort,
)


class BugsCrawlerImpl(BugsCrawlerPort):
    """벅스뮤직 실시간 차트 크롤링 구현."""
