...
class SentimentInferenceService:
    ...
    def __init__(self):
        ...
        self.finetuned_model_path = "app/inference/koelectra_model_finetuned"
        self.base_model_path = "app/inference/koelectra_model"
...
KoELECTRASentimentService = SentimentInferenceService

# 싱글톤 인스턴스
_service_instance: Optional[SentimentInferenceService] = None

def get_sentiment_service() -> SentimentInferenceService:
    """KoELECTRA 감성분석 서비스 싱글톤 인스턴스 반환"""
    global _service_instance
    if _service_instance is None:
        _service_instance = SentimentInferenceService()
