...
def check_environment():
    ...
    # 데이터 파일 확인
    data_path = Path("/app/app/inference/data")
    if data_path.exists():
    ...
    # 모델 파일 확인
    model_path = Path("/app/app/inference/koelectra_model")
...
def run_training():
    ...
    try:
        ...
        trainer = SentimentModelTrainer(
            model_path="/app/app/inference/koelectra_model",
            data_path="/app/app/inference/data"
        )
