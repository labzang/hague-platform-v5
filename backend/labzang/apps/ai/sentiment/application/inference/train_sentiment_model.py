...
class SentimentModelTrainer:
    ...
    def __init__(
        self,
        model_path: str = "app/inference/koelectra_model",
        data_path: str = "app/inference/data",
    ):
    ...
    def train(self, epochs: int = 5, batch_size: int = 16, learning_rate: float = 2e-5):
        ...
        output_dir = f"app/inference/fine_tuned_model_{timestamp}"
        ...
        # 모델 저장
        final_model_path = "app/inference/koelectra_model_finetuned"
    ...
    def test_model(self, model_path: str = "app/inference/koelectra_model_finetuned"):
        """파인튜닝된 모델 테스트"""
...
KoELECTRATrainer = SentimentModelTrainer
