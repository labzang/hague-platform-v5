...
from labzang.apps.dash.kaggle.santander.application.ports import (
    ModelRunnerPort,
    PreprocessorPort,
    TitanicDataPort,
)
from labzang.apps.dash.kaggle.santander.application.ports.input.titanic_uc_port import (
...
class PreprocessTitanicUC(PreprocessTitanicUCPort):
...
class SubmitTitanicUC(SubmitTitanicUCPort):
    def __init__(
        self,
...
class EvaluateTitanicUC(EvaluateTitanicUCPort):
    def __init__(
        self,
        data_port: TitanicDataPort,
        preprocessor_port: PreprocessorPort,
