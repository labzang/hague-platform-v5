...
from labzang.apps.ai.chat.application.ports.output import ChatLLMPort
...
from labzang.apps.ai.chat.adapter.outbound.llm.providers.korean_hf_local import create_local_korean_llm
from labzang.apps.ai.chat.adapter.outbound.llm.providers.midm_local import create_midm_local_llm
