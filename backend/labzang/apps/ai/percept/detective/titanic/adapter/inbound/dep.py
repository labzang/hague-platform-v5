...
from labzang.apps.dash.council.illustrator.folium.adapter.outbound.impl.seoul_crime_repository_impl import (
    KakaoGeocodeAdapter,
...
from labzang.apps.dash.council.illustrator.folium.app.ports.input.seoul_crime_query_port import (
    SeoulCrimePort,
)
...
def get_wordcloud_resp_dep():
    ...
    from labzang.apps.dash.council.illustrator.cloud.adapter.inbound.schemas.samsung_response import (
        get_wordcloud_resp,
    )
