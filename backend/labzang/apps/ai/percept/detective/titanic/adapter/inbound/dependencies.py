...
from labzang.apps.dash.kaggle.santander.application.use_cases.titanic_uc import (
    EvaluateTitanicUC,
    PreprocessTitanicUC,
    SubmitTitanicUC,
)
...
def get_wordcloud_resp_dep():
    ...
    from labzang.apps.dash.wordcloud.adapter.inbound.api.schemas.wordcloud_resp import (
        get_wordcloud_resp,
    )
