...
from labzang.apps.dash.kaggle.santander.application.dtos.titanic_dto import EvaluationResult, PreprocessResult


def _run_preprocess(data_port: Any, preprocessor_port: Any) -> dict:
    from labzang.apps.dash.kaggle.santander.application.use_cases.titanic_uc import PreprocessTitanicUC
...
def _run_evaluate(data_port: Any, preprocessor_port: Any, model_port: Any) -> dict:
    from labzang.apps.dash.kaggle.santander.application.use_cases.titanic_uc import EvaluateTitanicUC
...
def _run_submit(data_port: Any, preprocessor_port: Any, model_port: Any) -> dict:
    from labzang.apps.dash.kaggle.santander.application.use_cases.titanic_uc import SubmitTitanicUC
