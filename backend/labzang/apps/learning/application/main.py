...
try:
    from adapter.input.api.v1 import seoul_crime_router as seoul_router
except ImportError:
    seoul_router = None
...
try:
    from adapter.input.api.v1.legacy_titanic_router import router as titanic_router
...
try:
    from adapter.input.api.v1 import titanic_router as hex_titanic_router
