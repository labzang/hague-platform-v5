...
**규칙 기반 CRUD vs 오케스트레이터(AI) 흐름도**는 [`../overview/ARCHITECTURE.md`](../overview/ARCHITECTURE.md) 참고. **application과 ontology를 분리했던 이유**는 [`../concepts/WHY_APPLICATION_AND_ONTOLOGY_WERE_SEPARATED.md`](../concepts/WHY_APPLICATION_AND_ONTOLOGY_WERE_SEPARATED.md) 참고.
