...
GOOGLE_REDIRECT_URI=api.labzang.com/api/oauth/google/callback

KAKAO_REST_API_KEY=your-kakao-rest-api-key
KAKAO_REDIRECT_URI=api.labzang.com/api/oauth/kakao/callback
...
### API 문서
- `api.labzang.com/swagger-ui.html` - Swagger UI
